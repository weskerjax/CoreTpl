...
namespace CoreTpl.Dao.Migrations
{
    ...
    [Migration("20200211090403_IdStart")]
            ...
            modelBuilder.Entity("CoreTpl.Dao.Database.RoleInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateBy = 1,
                            CreateDate = new DateTimeOffset(new DateTime(2020, 2, 11, 17, 4, 2, 736, DateTimeKind.Unspecified).AddTicks(8893), new TimeSpan(0, 8, 0, 0, 0)),
                            ModifyBy = 1,
                            ModifyDate = new DateTimeOffset(new DateTime(2020, 2, 11, 17, 4, 2, 739, DateTimeKind.Unspecified).AddTicks(8895), new TimeSpan(0, 8, 0, 0, 0)),
                            RoleName = "管理者",
                            UseStatus = "Enable"
                        });
                });
            ...
            modelBuilder.Entity("CoreTpl.Dao.Database.UserInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Account = "system",
                            CreateBy = 1,
                            CreateDate = new DateTimeOffset(new DateTime(2020, 2, 11, 17, 4, 2, 742, DateTimeKind.Unspecified).AddTicks(8897), new TimeSpan(0, 8, 0, 0, 0)),
                            ModifyBy = 1,
                            ModifyDate = new DateTimeOffset(new DateTime(2020, 2, 11, 17, 4, 2, 742, DateTimeKind.Unspecified).AddTicks(8897), new TimeSpan(0, 8, 0, 0, 0)),
                            UseStatus = "Disable",
                            UserName = "系統",
                            UserType = "System"
                        },
