            ...
            modelBuilder.Entity("CoreTpl.Dao.Database.RoleInfo", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            AllowActList = "RoleSetting,UserSetting",
                            CreateBy = 1,
                            CreateDate = new DateTimeOffset(new DateTime(2020, 2, 10, 17, 3, 32, 108, DateTimeKind.Unspecified).AddTicks(5599), new TimeSpan(0, 8, 0, 0, 0)),
                            ModifyBy = 1,
                            ModifyDate = new DateTimeOffset(new DateTime(2020, 2, 10, 17, 3, 32, 111, DateTimeKind.Unspecified).AddTicks(5601), new TimeSpan(0, 8, 0, 0, 0)),
                            RoleName = "管理者",
                            UseStatus = "Enable"
                        });
                });
            ...
            modelBuilder.Entity("CoreTpl.Dao.Database.UserInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Account = "system",
                            CreateBy = 1,
                            CreateDate = new DateTimeOffset(new DateTime(2020, 2, 10, 17, 3, 32, 113, DateTimeKind.Unspecified).AddTicks(5602), new TimeSpan(0, 8, 0, 0, 0)),
                            ModifyBy = 1,
                            ModifyDate = new DateTimeOffset(new DateTime(2020, 2, 10, 17, 3, 32, 113, DateTimeKind.Unspecified).AddTicks(5602), new TimeSpan(0, 8, 0, 0, 0)),
                            UseStatus = "Disable",
                            UserName = "系統",
                            UserType = "System"
                        },
                        new
                        {
                            ...
                            Account = "admin",
                            CreateBy = 1,
                            CreateDate = new DateTimeOffset(new DateTime(2020, 2, 10, 17, 3, 32, 114, DateTimeKind.Unspecified).AddTicks(5603), new TimeSpan(0, 8, 0, 0, 0)),
                            ModifyBy = 1,
                            ModifyDate = new DateTimeOffset(new DateTime(2020, 2, 10, 17, 3, 32, 114, DateTimeKind.Unspecified).AddTicks(5603), new TimeSpan(0, 8, 0, 0, 0)),
